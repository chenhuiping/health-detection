                            ...
                            <div class="row-fluid">
                                <div class="span6 ">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="m-wrap span6" value="<?=$typeName['name']?>"  disabled>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                ...
                                <div class="sapn6">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="m-wrap span6" value="<?=$fxz['fengxianzhi']?>"  id="fengxianzhi">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label">每十万人病例数
                                            <!--                                                                <span class="required">*</span>-->
                                        </label>
                                        <div class="controls">
                                            <input type="text" class="m-wrap span6" value="<?=$blInfo['bingli']?>" id="bingli" >
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
                                    ...
                                    <div class="row-fluid">
                                        <div class="span12">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <script id="editor" type="text/plain" style="width:100%;overflow:scroll;"><?=$blInfo['content']?></script>
                                                </div>
                                            </div>
                                        </div>
...
//            var FileExt=file.replace(/.+\./,"");   //正则表达式获取后缀
    ...
    function edit()
    {
        ...
        var addEventURL = "/jkSystem/admin/editUserBL_do";
        $.ajax({
            type: "post",
            url: addEventURL,
            dataType: "json",
