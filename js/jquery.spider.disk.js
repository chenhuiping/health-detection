...
(function ($){
	...
	$.fn.disk = function (id,options){
		...
		$.each(dataObj.disks,function (i,n){
			...
			//"<tr></tr>"
			var tds="<td width='8%' height='28px' align='right'><strong>"+n.name+"</strong></td><td width='30%' style='bgcolor:"+options.itemStyle.bgColor+";'>"+itemDiv+"</td><td width='12%'>【值："+percentage+"%】</td>";
			if(i%1==0){
				trs+="<tr>"+tds;
			}else{
				trs+=tds+"</tr>";
