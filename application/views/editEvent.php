                ...
                <div class="tab-pane " id="tab_1">
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder">添加活动</i></div>
                            <div class="tools">
                            ...
                            <div class="row-fluid">
                                <div class="span6 ">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="m-wrap span6" value="<?=$blInfo['name']?>" id="bingliName" >
                                        </div>
                                    </div>
<!--                                    <div class="control-group">-->
<!--                                        <label class="control-label">风险值</label>-->
<!--                                        <div class="controls">-->
<!--                                            <input type="text" class="m-wrap span6" value="--><?//=$blInfo['fengxianzhi']?><!--"  id="fengxianzhi" disabled>-->
<!--                                        </div>-->
<!--                                    </div>-->
                                </div>
<!--                                <div class="sapn6">-->
<!--                                    <div class="control-group">-->
<!--                                        <label class="control-label">病例-->
<!--                                            <!--                                                                <span class="required">*</span>-->
<!--                                        </label>-->
<!--                                        <div class="controls">-->
<!--                                            <input type="text" class="m-wrap span6" value="--><?//=$blInfo['bingli']?><!--" id="bingli" disabled>-->
<!--                                        </div>-->
<!--                                    </div>-->
<!--                                </div>-->
                                <!--/span-->
                            ...
                            <div class="row-fluid">
                                <div class="span12">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <script id="editor" type="text/plain" style="width:100%;overflow:scroll;" >
                                                <?=$blInfo['content']?>;
...
//            var FileExt=file.replace(/.+\./,"");   //正则表达式获取后缀
    ...
    function edit()
    {
        ...
        var blId = <?=$blInfo['blId']?>;
        var bingliName = document.getElementById('bingliName').value;

        var content =UE.getEditor('editor').getContent();

        var addEventURL = "/jkSystem/event/editBlingli_do";
        $.ajax({
            type: "post",
            url: addEventURL,
            dataType: "json",
            ...
            success: function (data) {
                ...
                {
                    alert('修改成功');
                    window.location.href='/jkSystem/event/Manage';
                }
                else{
                    alert('修改失败');
                }
