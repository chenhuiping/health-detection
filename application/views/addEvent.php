												...
												<div class="row-fluid">
													<div class="span6 ">
														<div class="control-group">
															...
															<div class="controls">
																<input type="text" class="m-wrap span6" placeholder="强迫症" id="bingliName">
															</div>
														</div>
...
<!--                                                        </div>-->
                                                        ...
                                                        <div class="form-actions">
                                                            <button type="button" class="btn blue" onclick="add()"><i class="icon-ok"></i> 保存</button>
...
//            var bingli = document.getElementById('bingli').value;
            ...
            var addEventURL = "/jkSystem/event/addEvent_do";
            $.ajax({
                type: "post",
                url: addEventURL,
                dataType: "json",
